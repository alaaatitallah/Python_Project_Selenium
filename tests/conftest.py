...
def setup():
    ...
    """
    driver = webdriver.Chrome()  # Initialisation d'une instance de WebDriver pour le navigateur Chrome
    return driver  # Retourne l'instance de WebDriver pour utilisation dans les tests
